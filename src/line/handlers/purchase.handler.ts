      ...
      try {
        const order = await runWithAuditContext(
          ...
          () => purchaseOrderService.create(tenantId, {
            ...
            staffPhone: (employee as { phone?: string | null }).phone ?? undefined,
        ...
        return {
          ...
          body: {
            ...
            contents: [
              ...
              { type: 'text', text: o.supplier.name, size: 'sm', color: '#555555', wrap: true },
          ...
          footer: {
            ...
            contents: [{
              ...
              color: '#06c755',
              height: 'sm',
              action: { type: 'uri', label: `purchase-${o.orderNo}.pdf`.slice(0, 20), uri: pdfUrl },
            }],
          },
        };
      }));
